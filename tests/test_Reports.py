...
class ReportsTest(unittest.TestCase):
	...
	@classmethod
	def _generate_db(cls, compression, encription=0):
		...
		# Primer reporte
		db	= Database(file=cls._filename, mode="wb", default_compress_method=compression, default_encription_method=encription, pages_in_container=10)
		...
		# Segundo reporte
		db	= Database(file=cls._filename, mode="ab", default_compress_method=compression, default_encription_method=encription, pages_in_container=10)
